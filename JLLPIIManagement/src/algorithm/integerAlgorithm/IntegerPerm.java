package algorithm.integerAlgorithm;
 ...
 * @author Martin Ross
 */
public class IntegerPerm implements Algorithm{
	...
	public <T> T init(T dataValue) {
    	// here we may need to think about the length of the new integer, if it fits some special application systems, 
    	// like afm_flds.afm_size
    	
    	Integer originalInteger = (Integer) dataValue;
    	Integer result = new Integer(encipher(originalInteger.intValue()));
    	return (T) result;
	}
